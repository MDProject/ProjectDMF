...
Net_CNN = DMFNet(struct_cnn,5,input_size = 28, weight = weight_cnn, bias = bias_cnn, input_CTensor = Input_CTensor, input_h_mean = h_mean, detailed_info = True, eigen_check = False)
