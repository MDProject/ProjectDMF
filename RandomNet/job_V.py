...
fpath_cifar10_param = './ProjectDMF/TrueDataTrain/TrueDataCorvariance_Cifar10'

# true corvariance - trained parameters for CIFAR10
fp = open(fpath_cifar10_param,'rb')
###### random param ######
struct_cnn = [3,5]
weight_cnn = None
bias_cnn = None
...
Net_CNN = DMFNet(struct_cnn,5,input_size = 32, weight = weight_cnn, bias = bias_cnn, input_CTensor = Input_CTensor, input_h_mean = h_mean, detailed_info = True, eigen_check = False)
